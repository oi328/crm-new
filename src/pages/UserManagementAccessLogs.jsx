...
import { Filter, ChevronDown, Search, Calendar, ArrowUpDown, ChevronLeft, ChevronRight } from 'lucide-react';
...
const mockAccess = [
  { id: 1, user: 'Ibrahim', login: '2025-11-18 10:24', logout: '2025-11-18 18:04', ip: '192.168.1.12', location: 'Cairo', device: 'Windows PC', browser: 'Chrome' },
  { id: 2, user: 'Sara', login: '2025-11-17 09:14', logout: '2025-11-17 17:01', ip: '192.168.1.18', location: 'Giza', device: 'MacBook', browser: 'Safari' },
  { id: 3, user: 'Mohamed', login: '2025-11-16 08:33', logout: '2025-11-16 16:22', ip: '192.168.1.21', location: 'Alexandria', device: 'iPhone', browser: 'Safari' },
];
...
export default function UserManagementAccessLogs() {
  ...
  const [logs] = useState(mockAccess);
  ...
  const exportToExcel = () => {
    ...
    XLSX.writeFile(workbook, "access-logs.xlsx");
  };
