...
export default function Brands() {
  ...
  const labels = useMemo(() => ({
    ...
    sortNameAsc: isRTL ? 'الاسم (أ-ي)' : 'Name (A-Z)',
    sortNameDesc: isRTL ? 'الاسم (ي-أ)' : 'Name (Z-A)',
    sortNewest: isRTL ? 'الأحدث بالإضافة' : 'Newest Added',
    hasWebsite: isRTL ? 'الموقع الإلكتروني' : 'Website Status',
    all: isRTL ? 'الكل' : 'All',
    yes: isRTL ? 'متوفر' : 'Available',
    no: isRTL ? 'غير متوفر' : 'Not Available',
