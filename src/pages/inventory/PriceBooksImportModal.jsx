...
const PriceBooksImportModal = ({ onClose, onImport, isRTL }) => {
  ...
  const generateTemplate = () => {
    const templateData = [
      {
        'Name': isRTL ? 'قائمة أسعار قياسية' : 'Standard Price Book',
        'Currency': 'EGP',
        'Valid From': '2024-01-01',
        'Valid To': '2024-12-31',
        'Status': 'Active',
        'Description': isRTL ? 'القائمة الرئيسية لعام 2024' : 'Main price list for 2024'
      }
    ]
    ...
    XLSX.writeFile(workbook, 'price_books_template.xlsx')
  }
      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-bold" style={{ color: isDark ? 'white' : '#111827' }}>{isRTL ? 'استيراد قوائم الأسعار' : 'Import Price Books'}</h3>
          </div>
          <button
            onClick={onClose}
...
export default PriceBooksImportModal
