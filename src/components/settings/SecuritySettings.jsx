          ...
          <div className="glass-panel rounded-2xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="password" className="input-soft w-full" placeholder={t('security.newPassword')} value={newPwd} onChange={e=>setNewPwd(e.target.value)} />
              ...
              <div className="md:col-span-2">
                ...
                <input type="password" className="input-soft w-full" placeholder={t('security.confirmPassword')} value={confirmPwd} onChange={e=>setConfirmPwd(e.target.value)} />
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="flex items-center justify-between p-3 rounded-lg border bg-white/90 dark:bg-gray-800/80">
                ...
                <label className="inline-flex items-center cursor-pointer">
                  <input type="checkbox" className="hidden" checked={twoFactor} onChange={e=>setTwoFactor(e.target.checked)} />
                  <span className={`w-10 h-6 rounded-full p-1 ${twoFactor?'bg-emerald-500':'bg-gray-400'} transition-all`}>
              ...
              <div className="md:col-span-3 flex items-center justify-end">
                <button className="btn btn-primary" disabled={!twoFactor} onClick={()=>setOpenSetup2FA(true)}>{t('security.setup2fa')}</button>
              </div>
            </div>
          </div>
