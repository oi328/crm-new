...
const LeadDetailsModal = ({ isOpen, onClose, lead }) => {
  ...
  // Sample actions data - في التطبيق الحقيقي، ستأتي هذه البيانات من قاعدة البيانات
  const leadActions = [
    {
      id: 1,
      type: 'call',
        ...
        <div className="bg-gray-50/50 px-8 pt-6">
          <div className="flex space-x-1 rtl:space-x-reverse bg-gray-100 rounded-2xl p-1.5">
            ...
            >
              ...
              <span>{isArabic ? `الأكشنز والأنشطة` : `Actions & Activities`}</span>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {action.notes && (
                            <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                              <p className="text-sm text-gray-700 leading-relaxed">{action.notes}</p>
                            </div>
                          )}
                        </div>
                      </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="bg-gradient-to-r from-green-100 to-teal-100 px-3 py-1 rounded-full">
                      <span className="text-green-700 font-medium text-sm">{comments.length} {isArabic ? 'تعليق' : 'comments'}</span>
                    </div>
                  </div>
                  ...
                  {comments.length > 0 ? (
                    <div className="space-y-4">
                      {comments.map((comment, index) => (
                        <div key={comment.id} className="bg-white border-2 border-gray-100 rounded-xl p-5 shadow-md hover:shadow-lg transition-all duration-200 transform hover:-translate-y-1">
                          ...
                          <div className="bg-gradient-to-r from-gray-50 to-blue-50 p-4 rounded-lg border-l-4 border-blue-500">
