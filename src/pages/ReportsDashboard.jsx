...
import { 
  ...
  Key, FileText, MapPin, Users, DollarSign, Download, Upload,
...
const ReportsDashboard = () => {
  ...
  const reports = [
    ...
    { 
      ...
      trend: '',
      trendUp: true,
      color: 'text-theme-text dark:text-white',
          ...
          return (
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4 relative z-10">
                ...
                {report.trend && (
                  <div className={`flex items-center text-xs font-bold px-2.5 py-1 rounded-full ${
                    ...
                    {report.trendUp ? <TrendingUp size={14} className="mr-1 rtl:ml-1" /> : <TrendingDown size={14} className="mr-1 rtl:ml-1" />}
                    {report.trend}
                  </div>
                )}
              </div>
              ...
              <div className="relative z-10">
                <h3 className="text-theme-text dark:text-white text-sm font-semibold mb-1">
                  {t(report.name)}
                </h3>
                <div className="flex items-baseline space-x-2 rtl:space-x-reverse">
                  ...
                  <span className="text-xs text-theme-text dark:text-gray-300 font-medium">
                    {t(report.label)}
                  </span>
                </div>
              </div>
